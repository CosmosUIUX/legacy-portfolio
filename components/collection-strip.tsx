  ...
  return (
    ...
    >
        ...
        <Reveal>
          <div className="container-custom text-center px-4 sm:px-6">
            ...
            <p className="text-base sm:text-lg text-neutral-600 max-w-2xl mx-auto px-2">
              Discover our signature interior design styles, each crafted to
      ...
      <div className="text-center mt-6 sm:mt-8 px-4">
        <motion.p 
          className="text-sm sm:text-base text-neutral-600 font-medium bg-neutral-100 px-4 py-2 rounded-full inline-block"
...
function CollectionOverlay({ collection }: { collection: any }) {
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center p-4">
      ...
      >
        <h3 className="text-sm sm:text-lg lg:text-xl xl:text-2xl font-bold tracking-wide mb-2 leading-tight px-3 break-words">
          {collection.name}
        </h3>
