...
interface PageTransitionProps {
  ...
  direction?: 'slide-left' | 'slide-right' | 'slide-up' | 'slide-down' | 'fade' | 'scale' | 'blur-fade' | 'zoom-fade'
  duration?: number
  loading?: boolean
  loadingText?: string
...
interface SectionTransitionProps {
  ...
  className?: string
  delay?: number
  animationType?: 'fade-up' | 'fade-in' | 'slide-left' | 'slide-right' | 'scale' | 'blur-fade'
  threshold?: number
  onEnterView?: () => void
  onExitView?: () => void
}
...
export function SectionTransition({ 
  ...
  return (
    <motion.section
      ...
      animate={shouldAnimate && viewportAnimation.isInView ? "visible" : "hidden"}
...
export function usePageTransition() {
  ...
  const [loadingState, setLoadingState] = React.useState<'idle' | 'loading' | 'complete'>('idle')
...
export function useFocusManagement() {
  ...
  const focusMainContent = React.useCallback((options?: {
  ...
  const preserveFocus = React.useCallback(() => {
    ...
    return () => {
      ...
      if (activeElement && activeElement instanceof HTMLElement) {
        ...
        if (document.contains(activeElement) && !activeElement.hasAttribute('disabled')) {
  ...
  const createSkipLink = React.useCallback((targetSelector: string = 'main') => {
