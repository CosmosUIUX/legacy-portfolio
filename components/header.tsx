...
export function Header() {
  ...
  return (
    <>
            ...
            >
              <a href="#" className="flex items-center gap-3 group" aria-label="Legacy Interiors and Developers Home">
                <motion.div
                  className="relative"
                  animate={{
                    opacity: logoOpacity.get ? logoOpacity.get() : logoOpacity,
                    scale: logoScale.get ? logoScale.get() : logoScale,
                  }}
                  whileHover={{
                    scale: 1.05,
                    rotate: [0, -2, 2, 0],
                ...
                <div className="flex flex-col">
                  <motion.span
                    ...
                    animate={{
                      color: isScrolled ? "rgb(23, 23, 23)" : "rgb(255, 255, 255)",
                  ...
                  <motion.span
                    ...
                    animate={{
                      color: isScrolled ? "rgb(82, 82, 82)" : "rgba(255, 255, 255, 0.7)",
      ...
      {!isMenuOpen && (
        <motion.button
          className="fixed top-0 left-4 z-[25] flex items-center justify-center w-12 rounded-lg h-12 lg:h-16"
          ...
          whileHover={{
            scale: 1.08,
            backgroundColor: isScrolled ? "rgba(0, 0, 0, 0.08)" : "rgba(255, 255, 255, 0.12)",
            color: isScrolled ? "rgb(64, 64, 64)" : "rgba(255, 255, 255, 0.9)",
            transition: { type: "spring", stiffness: 400, damping: 17 },
          }}
          whileTap={{
            scale: 0.92,
            backgroundColor: isScrolled ? "rgba(0, 0, 0, 0.12)" : "rgba(255, 255, 255, 0.16)",
          }}
          ...
          {...menuButtonMotion.eventHandlers}
        >
          <motion.div
            animate={{ rotate: menuButtonMotion.isHovered ? 180 : 0 }}
