    ...
    <AnimatePresence mode="wait">
      {isOpen && (
        <>
          ...
          {/* Sidebar */}
          <motion.div
            className="fixed top-0 left-0 h-full w-full sm:w-[400px] max-w-sm z-[120] bg-black/90 backdrop-blur-2xl shadow-2xl border-r border-white/10"
            ...
            <div className="flex flex-col h-full">
              ...
              >
                ...
                <p className="text-sm text-white/80 leading-relaxed">
                  Creating beautiful spaces that inspire and transform your
                  vision into reality.
                </p>
              </motion.div>
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex flex-col">
                          <motion.span className="font-semibold text-white text-base mb-1">
                            {item.label}
                          </motion.span>
                          <motion.span className="text-xs text-white/60 font-medium">
                            {item.description}
                          </motion.span>
                        </div>
                      </motion.div>
