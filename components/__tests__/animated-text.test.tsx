...
describe('AnimatedText - Motion.dev Enhanced', () => {
    ...
    describe('Basic Rendering', () => {
        it('renders text correctly with Motion.dev components', () => {
            const { container } = renderWithProvider(<AnimatedText text="Hello World" />)
    ...
    describe('Character Animation Type', () => {
        it('splits text into individual characters', () => {
            renderWithProvider(
                <AnimatedText text="ABC" animationType="character" />
            )
        ...
        it('applies character-specific animation variants', () => {
            renderWithProvider(
                <AnimatedText text="AB" animationType="character" />
            )
    ...
    describe('Word Animation Type', () => {
        ...
        it('handles single word correctly', () => {
            renderWithProvider(
                <AnimatedText text="Single" animationType="word" />
            )
    ...
    describe('Animation Configuration', () => {
        ...
        it('uses cinematic easing by default', () => {
            ...
            const motionSpans = screen.getAllByTestId('motion-span')
            const transition = JSON.parse(motionSpans[0].getAttribute('data-transition') || '{}')
    ...
    describe('Edge Cases', () => {
        it('handles text with only spaces', () => {
            renderWithProvider(
                <AnimatedText text="   " animationType="character" />
            )
