...
jest.mock('motion/react', () => ({
  motion: {
    div: ({ children, whileHover, whileTap, animate, initial, variants, exit, transition, ...props }: any) => <div {...props}>{children}</div>,
    button: ({ children, whileHover, whileTap, animate, initial, variants, exit, transition, ...props }: any) => <button {...props}>{children}</button>,
    span: ({ children, whileHover, whileTap, animate, initial, variants, exit, transition, ...props }: any) => <span {...props}>{children}</span>,
    h4: ({ children, whileHover, whileTap, animate, initial, variants, exit, transition, ...props }: any) => <h4 {...props}>{children}</h4>,
    p: ({ children, whileHover, whileTap, animate, initial, variants, exit, transition, ...props }: any) => <p {...props}>{children}</p>
  },
...
describe('FormFeedback', () => {
  ...
  it('should render success message', () => {
    render(
      <FormFeedback state="success" message="Success message" onDismiss={() => {}} />
    )
  ...
  it('should render error message', () => {
    render(
      <FormFeedback state="error" message="Error message" />
    )
  ...
  it('should render submitting state', () => {
    render(
      <FormFeedback state="submitting" message="Submitting..." />
    )
