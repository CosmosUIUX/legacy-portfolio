...
function AnimationErrorDemo() {
  ...
  const { errors, logError, clearErrors, getErrorStats } = useAnimationErrorLogger()
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        ...
        <div style={{ 
          padding: '10px', 
          backgroundColor: healthStatus.performanceGood ? '#d1fae5' : '#fee2e2',
          borderRadius: '8px',
          marginBottom: '10px'
        }}>
          <div>Motion Available: {healthStatus.motionAvailable ? '✅' : '❌'}</div>
          <div>Performance Good: {healthStatus.performanceGood ? '✅' : '⚠️'}</div>
