...
import type { MotionProviderProps, MotionContextValue, AnimationConfig } from './types'
...
export function MotionProvider({
  ...
  const reducedMotion = forcedReducedMotion ?? systemReducedMotion ?? isScreenReader

  // Auto-detect performance mode based on device capabilities
  const [performanceMode, setPerformanceMode] = useState<'high' | 'balanced' | 'battery'>(() => {
  ...
  const [animationConfig, setAnimationConfig] = useState<Record<string, AnimationConfig>>({})
  ...
  }, [reducedMotion, performanceMode, isScreenReader, enablePerformanceMonitoring])
