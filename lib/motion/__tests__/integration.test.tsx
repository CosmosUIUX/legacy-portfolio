...
describe("Animation Integration Tests", () => {
  ...
  describe("Component Animation Interactions", () => {
    ...
    it("should work with different performance modes", async () => {
      const { rerender } = renderWithMotion(<AnimatedTestComponent />, {
  ...
  describe("Accessibility Integration", () => {
    it("should provide proper ARIA attributes during animations", async () => {
      ...
      await waitFor(
        () => {
          const completedAria =
            AccessibilityTestUtils.testAriaAttributes(button);
  ...
  describe("Performance Integration", () => {
    it("should maintain 60fps during animations", async () => {
      const { container } = renderWithMotion(
        <AnimatedTestComponent enableAccessibility={false} />,
      );
    ...
    it("should perform well under load", async () => {
      ...
      const performanceResult =
        await PerformanceTestUtils.testPerformanceUnderLoad(
          () => {
            // Animation callback
            const element = container.querySelector("button");
            if (element) {
