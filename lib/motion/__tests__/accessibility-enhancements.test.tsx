...
describe('Accessibility Enhancements', () => {
  ...
  describe('SkipNavigation', () => {
    it('should render skip navigation links', () => {
      ...
      const mockUseKeyboardNavigation = require('../accessibility').useKeyboardNavigation
      ...
      const skipNav = screen.getByRole('navigation', { name: 'Skip navigation' })
  ...
  describe('ReducedMotionProvider', () => {
    ...
    it('should save preferences to localStorage', () => {
      ...
      expect(mockLocalStorage.setItem).toHaveBeenCalledWith('motion-preference', 'reduce')
    })
  })
    ...
    it('should adapt configuration based on performance level', () => {
      ...
      const TestComponent = () => (
        <ReducedMotionProvider>
          ...
          >
            {(config) => (
              <div data-testid="adaptive-config">
                {JSON.stringify(config)}
              </div>
            )}
          </AdaptiveMotion>
