...
describe('AnimationLazyLoader', () => {
  ...
  it('should track loaded animations', async () => {
    ...
    jest.spyOn(lazyLoader as any, 'dynamicImportAnimation').mockResolvedValue({})
  ...
  it('should handle loading errors gracefully', async () => {
    jest.spyOn(lazyLoader as any, 'dynamicImportAnimation').mockRejectedValue(new Error('Load failed'))
    
    await expect(lazyLoader.loadAnimation('failing-animation')).rejects.toThrow('Load failed')
