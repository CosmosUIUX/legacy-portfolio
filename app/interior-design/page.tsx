  ...
  const services = [
    {
      ...
      description:
        "Comprehensive design planning tailored to your vision and lifestyle needs.",
    },
    {
      icon: Home,
    ...
    },
    {
      ...
      description:
        "Creating ambiance through strategic lighting solutions and fixtures.",
    },
    {
      icon: Ruler,
      title: "Custom Solutions",
      description:
        "Bespoke furniture and built-in elements designed for your space.",
    },
  ];
          ...
          <Reveal>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-neutral-600 leading-relaxed">
                ...
                creating environments that reflect your personality and enhance
                your lifestyle.
              </p>
            </div>
          </Reveal>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                step: "03",
                title: "Selection",
                description: "Choosing materials, furniture, and finishes",
              },
              {
                step: "04",
                title: "Installation",
                description: "Professional implementation and styling",
              },
            ].map((phase, index) => (
