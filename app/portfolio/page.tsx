  ...
  const projects = [
    {
      ...
      description:
        "A stunning contemporary staircase featuring floating wood steps and elegant pendant lighting.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Transforming a traditional office into a modern collaborative workspace.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Sophisticated interior design for a high-end urban apartment.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Complete development of a boutique hotel with unique character.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Comprehensive renovation preserving character while adding modern amenities.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Creating an inviting atmosphere for a fine dining establishment.",
      longDescription:
