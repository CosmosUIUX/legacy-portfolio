  ...
  const services = [
    {
      ...
      description:
        "Custom homes and residential projects built to the highest standards.",
    },
    {
      icon: Hammer,
      title: "Commercial Construction",
      description:
        "Office spaces, retail environments, and commercial developments.",
    },
    {
      icon: Shield,
      title: "Renovation & Restoration",
      description:
        "Breathing new life into existing spaces with expert craftsmanship.",
    },
    {
      icon: Clock,
          ...
          <Reveal>
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-neutral-600 leading-relaxed">
                From concept to completion, we deliver exceptional development
            ...
            {[
              {
                ...
                description:
                  "Decades of experience in construction and development with attention to every detail.",
              },
              {
                title: "Sustainable Practices",
                description:
                  "Environmentally conscious building methods and materials for a better future.",
              },
              {
